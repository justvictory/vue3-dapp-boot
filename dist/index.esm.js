...
const _withScopeId = n => (pushScopeId("data-v-04a0d67a"),n=n(),popScopeId(),n);
const _hoisted_1$4 = { class: "modal" };
const _hoisted_2$4 = /*#__PURE__*/ _withScopeId(() => /*#__PURE__*/createElementVNode("div", { class: "lds-ripple" }, [
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (openBlock(), createElementBlock(Fragment, null, [
    ...
    renderSlot(_ctx.$slots, "connecting", {}, () => [
      createCommentVNode("    <Modal :modalOpen=\"wallet.status === 'connecting'\" :dark=\"dark\">"),
      createCommentVNode("      <div class=\"loading-modal\" v-if=\"wallet.status === 'connecting'\">"),
      createCommentVNode("        <p>Connecting...</p>"),
      createCommentVNode("        <p class=\"mt-4\">Approve or reject request using your wallet</p>"),
      createCommentVNode("      </div>"),
      createCommentVNode("    </Modal>")
    ]),
    renderSlot(_ctx.$slots, "loading", {}, () => [
      createCommentVNode("    <Modal :modalOpen=\"wallet.status === 'loading'\" :dark=\"dark\"></Modal>")
    ])
  ], 64 /* STABLE_FRAGMENT */))
}
