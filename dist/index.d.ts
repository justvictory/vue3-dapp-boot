...
declare function useBoard(): {
    ...
    openBoard: () => void;
    closeBoard: () => void;
    boardOpenConnecting: vue.Ref<boolean>;
    openConnectingBoard: () => void;
    closeConnectingBoard: () => void;
};
...
declare function useWallet(options?: useWalletOptions): {
    ...
    connectWithWallet: (connector: Connector) => Promise<void>;
    disconnectWallet: () => Promise<void>;
    onDisconnectWallet: (callback: OnDisconnectCallback) => void;
    onAccountsChangedWallet: (callback: OnAccountsChangedCallback) => void;
...
declare function useEthersHooks(): {
    onProviderActivated: (hook: OnActivatedHook) => void;
    onProviderDeactivated: (hook: OnDeactivatedHook) => void;
    onProviderChanged: (hook: OnChangedHook) => void;
};
