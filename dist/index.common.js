...
const _withScopeId = n => (vue.pushScopeId("data-v-04a0d67a"),n=n(),vue.popScopeId(),n);
const _hoisted_1$4 = { class: "modal" };
const _hoisted_2$4 = /*#__PURE__*/ _withScopeId(() => /*#__PURE__*/vue.createElementVNode("div", { class: "lds-ripple" }, [
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (vue.openBlock(), vue.createElementBlock(vue.Fragment, null, [
    ...
    vue.renderSlot(_ctx.$slots, "connecting", {}, () => [
      vue.createCommentVNode("    <Modal :modalOpen=\"wallet.status === 'connecting'\" :dark=\"dark\">"),
      vue.createCommentVNode("      <div class=\"loading-modal\" v-if=\"wallet.status === 'connecting'\">"),
      vue.createCommentVNode("        <p>Connecting...</p>"),
      vue.createCommentVNode("        <p class=\"mt-4\">Approve or reject request using your wallet</p>"),
      vue.createCommentVNode("      </div>"),
      vue.createCommentVNode("    </Modal>")
    ]),
    vue.renderSlot(_ctx.$slots, "loading", {}, () => [
      vue.createCommentVNode("    <Modal :modalOpen=\"wallet.status === 'loading'\" :dark=\"dark\"></Modal>")
    ])
  ], 64 /* STABLE_FRAGMENT */))
}
