...
const CONFIG_RPC_FOR_INFURA_IDS = {
    ...
    [exports.ChainId.GonChain]: `https://node1.testnet.gaiaopen.network`,
};
const CHAIN_NAMES = {
    ...
    [exports.ChainId.HECOTestnet]: 'Testnet',
    [exports.ChainId.GonChain]: 'GonChain'
};
...
const NETWORK_DETAILS = {
    ...
    [exports.ChainId.HECOTestnet]: {
        chainId: '0x' + exports.ChainId.HECOTestnet.toString(16),
    ...
    [exports.ChainId.GonChain]: {
        chainId: '0x' + exports.ChainId.GonChain.toString(16),
        chainName: 'Gon Chain',
        nativeCurrency: {
            symbol: 'GT',
            decimals: 18,
...
const boardOpenConnecting = vue.ref(false);
function useBoard() {
    const openBoard = () => {
...
(function (ConnectionStatus) {
    ...
    ConnectionStatus[ConnectionStatus["LOADING"] = 2] = "LOADING";
...
const wallet = vue.reactive({
    ...
    code: 0,
    error: '',
    status: exports.ConnectionStatus.NONE,
});
...
function useWallet(options = { useEthers: true }) {
    const clearWallet = () => {
        ...
        wallet.code = 0;
        wallet.error = '';
        wallet.status = exports.ConnectionStatus.NONE;
    ...
    function reactivate() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            wallet.status = exports.ConnectionStatus.CONNECTED;
        });
    }
    function connectWithWallet(connector) {
        return __awaiter(this, void 0, void 0, function* () {
            wallet.status = exports.ConnectionStatus.CONNECTING;
            wallet.code = 0;
            wallet.error = '';
            try {
                if (!connector)
...
script$6.__scopeId = "data-v-701ac82d";
script$6.__file = "src/components/Modal.vue";

const _withScopeId$2 = n => (vue.pushScopeId("data-v-efe9d588"),n=n(),vue.popScopeId(),n);
const _hoisted_1$5 = { class: "module-loading" };
const _hoisted_2$5 = /*#__PURE__*/ _withScopeId$2(() => /*#__PURE__*/vue.createElementVNode("div", { class: "lds-ring" }, [
...
function render$5(_ctx, _cache) {
  return (vue.openBlock(), vue.createElementBlock("div", _hoisted_1$5, _hoisted_3$5))
}

var css_248z$2 = "\n.module-loading[data-v-efe9d588] {\n  text-align: center;\n}\n.module-loading >img[data-v-efe9d588] {\n  display: inline-block;\n}\n.lds-ring[data-v-efe9d588] {\n  display: inline-block;\n  position: relative;\n  width: 64px;\n  height: 64px;\n}\n.lds-ring div[data-v-efe9d588] {\n  box-sizing: border-box;\n  display: block;\n  position: absolute;\n  width: 40px;\n  height: 40px;\n  margin: 8px;\n  border: 5px solid #fff;\n  border-radius: 50%;\n  animation: lds-ring-efe9d588 1.2s cubic-bezier(0.5, 0, 0.5, 1) infinite;\n  border-color: #fff transparent transparent transparent;\n}\n.lds-ring div[data-v-efe9d588]:nth-child(1) {\n  animation-delay: -0.45s;\n}\n.lds-ring div[data-v-efe9d588]:nth-child(2) {\n  animation-delay: -0.3s;\n}\n.lds-ring div[data-v-efe9d588]:nth-child(3) {\n  animation-delay: -0.15s;\n}\n@keyframes lds-ring-efe9d588 {\n0% {\n    transform: rotate(0deg);\n}\n100% {\n    transform: rotate(360deg);\n}\n}\n";
styleInject(css_248z$2);

const script$5 = {};

script$5.render = render$5;
script$5.__scopeId = "data-v-efe9d588";
script$5.__file = "src/components/Loading.vue";

const _withScopeId$1 = n => (vue.pushScopeId("data-v-026a7a08"),n=n(),vue.popScopeId(),n);
const _hoisted_1$4 = { class: "module-error" };
const _hoisted_2$4 = /*#__PURE__*/ _withScopeId$1(() => /*#__PURE__*/vue.createElementVNode("svg", {
  t: "1655011631362",
  class: "icon",
...
var css_248z$1 = "\n.module-error[data-v-026a7a08] {\n  text-align: center;\n}\n.module-error > svg[data-v-026a7a08] {\n  display: inline-block;\n}\n";
styleInject(css_248z$1);

const script$4 = {};

script$4.render = render$4;
script$4.__scopeId = "data-v-026a7a08";
script$4.__file = "src/components/Error.vue";
...
var script = vue.defineComponent({
    ...
    setup(props) {
        ...
        return {
            ConnectionStatus: exports.ConnectionStatus,
            boardOpen,
            closeBoard,
            boardOpenConnecting,
            closeConnectingBoard,
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (vue.openBlock(), vue.createElementBlock(vue.Fragment, null, [
    vue.createVNode(_component_Modal, {
      ...
      default: vue.withCtx(() => [
        vue.withDirectives((vue.openBlock(), vue.createElementBlock("div", null, [
          (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(_ctx.connectors, (connector, i) => {
            return (vue.openBlock(), vue.createElementBlock("div", {
              ...
              vue.createElementVNode("div", {
                ...
                onClick: $event => (_ctx.connectWithWallet(connector) && _ctx.closeBoard())
              }, [
          ...
          [_directive_click_outside, _ctx.closeBoard]
        ])
      ]),
      _: 1 /* STABLE */
    ...
    vue.renderSlot(_ctx.$slots, "connecting", {}, () => [
      vue.createVNode(_component_Modal, {
        modalOpen: _ctx.wallet.status === _ctx.ConnectionStatus.CONNECTING,
        dark: _ctx.dark,
        onClose: _cache[0] || (_cache[0] = $event => (_ctx.wallet.status = _ctx.ConnectionStatus.NONE))
      }, {
        default: vue.withCtx(() => [
    ...
    vue.renderSlot(_ctx.$slots, "loading", {}, () => [
      vue.createCommentVNode("    <Modal :modalOpen=\"wallet.status === ConnectionStatus.LOADING\" :dark=\"dark\" @close=\"wallet.status = ConnectionStatus.NONE\">"),
      vue.createCommentVNode("      <div class=\"loading-modal\">"),
      vue.createCommentVNode("        <loading />"),
      vue.createCommentVNode("        <p>Loading...</p>"),
      ...
      vue.createVNode(_component_Modal, {
        ...
        default: vue.withCtx(() => [
          vue.createElementVNode("div", _hoisted_8, [
            vue.createVNode(_component_error),
            (_ctx.wallet.code === -32002)
              ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_9, " The connection attempt failed. Please login in your wallet. "))
              : (vue.openBlock(), vue.createElementBlock("div", _hoisted_10, [
                  (_ctx.wallet.code)
                    ? (vue.openBlock(), vue.createElementBlock("p", _hoisted_11, "Code: " + vue.toDisplayString(_ctx.wallet.code), 1 /* TEXT */))
                    : vue.createCommentVNode("v-if", true),
                  vue.createElementVNode("p", null, vue.toDisplayString(_ctx.wallet.error), 1 /* TEXT */)
                ]))
          ])
        ]),
        _: 1 /* STABLE */
...
const VueDapp = {
    install(app) {
        ...
        app.component('vd-modal', script$6);
    },
};
